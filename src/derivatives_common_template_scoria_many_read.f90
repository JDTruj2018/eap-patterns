...
module my_scoria_many_read_derivatives
  ...
  contains
    subroutine derivatives_common_split_scoria_many_read(sim, mesh, &
      frac_core, core, &
      gradp, intopt, &
      ...
      call derivatives_common_internal_split_scoria_many_read(sim, mesh, cell_dim, numitr, nvec, kode, &
    ...
    end subroutine derivatives_common_split_scoria_many_read

    subroutine derivatives_common_internal_split_scoria_many_read(sim, mesh, &
      cell_dim, numitr, nvec, kode, &
      noslope_cell, deriv, do_fincom, &
      invalue, &
      ...
      associate (cells => mesh%cells, &
        ...
        call deriv_details_scoria_many_read(numitr, lv_weight, cell_dim, do_pressure,  &
              ...
              do itr  = 1,itrmax
                 ...
                 do nm = 1,nvec
                    ...
                    if (mesh%levels%allnumtop.gt.0) then
                       ...
                       call inside_com3b_scoria_many_read(sim, mesh, dir, nm, cell_val_mnmx_hilo, &
    ...
    contains
      ! ------------------------------------------------------------------------------
      subroutine deriv_details_scoria_many_read(numitr, lv_weight, cell_dim, &
      ...
      end subroutine deriv_details_scoria_many_read
      ! ------------------------------------------------------------------------------
    end subroutine derivatives_common_internal_split_scoria_many_read

    subroutine inside_com3b_scoria_many_read(sim, mesh, dir, nm, cell_val_mnmx_hilo, kode, &
      & cell_value_hilo, do_special, do_pressure, core, faceval)
      use iso_c_binding
      use iso_fortran_env, only: REAL64, INT64, INT32, INT8
      use scoria, only: scoria_read_1, scoria_write_1, scoria_read_1_many_2, scoria_read_1_many_3, scoria_read_1_many_4
      ...
      do loop = 1,faces%face_num(dir)
        ...
        if (present(do_special)) then
          call scoria_read_1_many_3(cell_value_hilo_lo_packed, cell_half_hi_lo_packed, rho_lo_packed, &
          & cell_value_hilo_2_scoria, cell_half_hi_scoria, rho_scoria, int(size(cell_value_hilo_2_scoria), &
          & kind=c_size_t), face_local_lo_scoria, scoria_n)
          call scoria_read_1_many_3(cell_half_lo_hi_packed, cell_value_hilo_hi_packed, rho_hi_packed, &
            & cell_half_lo_scoria, cell_value_hilo_1_scoria, rho_scoria, int(size(cell_half_lo_scoria), &
            & kind=c_size_t), face_local_hi_scoria, scoria_n)
        else 
          call scoria_read_1_many_2(cell_value_hilo_lo_packed, cell_half_hi_lo_packed, &
            & cell_value_hilo_2_scoria, cell_half_hi_scoria, int(size(cell_value_hilo_2_scoria), &
            & kind=c_size_t), face_local_lo_scoria, scoria_n)
          call scoria_read_1_many_2(cell_half_lo_hi_packed, cell_value_hilo_hi_packed, &
            & cell_half_lo_scoria, cell_value_hilo_1_scoria, int(size(cell_half_lo_scoria), &
            & kind=c_size_t), face_local_hi_scoria, scoria_n)
        endif

        call scoria_read_1_many_4(cell_val_mnmx_hilo_hi_1_packed, cell_val_mnmx_hilo_hi_2_packed, &
          & cell_val_mnmx_hilo_mi_1_packed, cell_val_mnmx_hilo_mi_2_packed, &
          & cell_val_mnmx_hilo_hi_1_scoria, cell_val_mnmx_hilo_hi_2_scoria, & 
          & cell_val_mnmx_hilo_mi_1_scoria, cell_val_mnmx_hilo_mi_2_scoria, &
          & int(size(cell_val_mnmx_hilo_hi_2_scoria), kind=c_size_t), face_local_hi_scoria, scoria_n)
        call scoria_read_1_many_4(cell_val_mnmx_hilo_lo_3_packed, cell_val_mnmx_hilo_lo_4_packed, &
          & cell_val_mnmx_hilo_mo_3_packed, cell_val_mnmx_hilo_mo_4_packed, &
          & cell_val_mnmx_hilo_lo_3_scoria, cell_val_mnmx_hilo_lo_4_scoria, & 
          & cell_val_mnmx_hilo_mo_3_scoria, cell_val_mnmx_hilo_mo_4_scoria, &
    ...
    end subroutine inside_com3b_scoria_many_read
end module my_scoria_many_read_derivatives