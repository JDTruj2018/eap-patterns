...
module my_scoria_derivatives
  ...
  contains
    subroutine derivatives_common_split_scoria(sim, mesh, &
      frac_core, core, &
      gradp, intopt, &
      ...
      call derivatives_common_internal_split_scoria(sim, mesh, cell_dim, numitr, nvec, kode, &
    ...
    end subroutine derivatives_common_split_scoria

    subroutine derivatives_common_internal_split_scoria(sim, mesh, &
      cell_dim, numitr, nvec, kode, &
      noslope_cell, deriv, do_fincom, &
      invalue, &
      ...
      associate (cells => mesh%cells, &
        ...
        call deriv_details_scoria(numitr, lv_weight, cell_dim, do_pressure,  &
              ...
              do itr  = 1,itrmax
                 ...
                 do nm = 1,nvec
                    ...
                    if (mesh%levels%allnumtop.gt.0) then
                       ...
                       call inside_com3b_scoria(sim, mesh, dir, nm, cell_val_mnmx_hilo, &
    ...
    contains
      ! ------------------------------------------------------------------------------
      subroutine deriv_details_scoria(numitr, lv_weight, cell_dim, &
      ...
      end subroutine deriv_details_scoria
      ! ------------------------------------------------------------------------------
    end subroutine derivatives_common_internal_split_scoria

    subroutine inside_com3b_scoria(sim, mesh, dir, nm, cell_val_mnmx_hilo, kode, &
      & cell_value_hilo, do_special, do_pressure, core, faceval)
      use iso_c_binding
      use iso_fortran_env, only: REAL64, INT64, INT32, INT8
      use scoria, only: scoria_read_1, scoria_write_1
    ...
    end subroutine inside_com3b_scoria
end module my_scoria_derivatives